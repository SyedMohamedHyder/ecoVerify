...
import (
	...
	"github.com/SyedMohamedHyder/ecoverify/business/data/dbmigrate"
...
func migrateSeed() error {
	var cfg struct {
		DB struct {
			...
			Host         string `conf:"default:database-service.ecoverify.svc.cluster.local"`
...
func opaPolicyEvaluation(ctx context.Context, opaPolicy string, input any) error {
	const opaPackage = "eco_verify.rego"
